...
def main():
    ...
    if data_args.train_file is not None or data_args.validation_file is not None:
        ...
        datasets = load_dataset("cosmos_qa") #load_dataset("swag", "regular")
    ...
    answer_names = [f"answer{i}" for i in range(4)]
    context_name = "context" #sent1
    ...
    def preprocess_function(examples):
        ...
        second_sentences = [
            [f"{header} {examples[end][i]}" for end in answer_names] for i, header in enumerate(question_headers)
        ]
